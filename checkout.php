	...
	<section class="konten">
		<div class="container">
			...
			if (isset($_POST["checkout"])) 
			{
				...
				$nama_prov = $arrayongkir['nama_prov'];
				$tarif = $arrayongkir['tarif'];

				$total_pembelian = $totalbelanja + $tarif;


				$koneksi->query("INSERT INTO pembelian(id_pelanggan,id_ongkir,tanggal_pembelian,total_pembelian,nama_prov,tarif,alamat_pengiriman) 
					VALUES ('$id_pelanggan','$id_ongkir','$tanggal_pembelian','$total_pembelian','$nama_prov','$tarif','$alamat_pengiriman')");
